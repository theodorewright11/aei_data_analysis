...
**Data Quality:** Analysis excludes 7 occupations (0.8%) where methodology produced >100% automation values, indicating data quality issues in SOC code transitions with frequency measurements.
...
---
### % Major Occupational Category Automated National

**Description**
- Shows the percent of the tasks automated in the 23 major occupational categories as defined by the Bureau of Labor Statistics using national employment numbers.
- Each bar represents one majory occupational category
- Percentages indicate what share of that majory occupational category's total task completions are AI-automatable.

**Notable Results:**
- Top 3 categories are Educational Instruction and Library (53%), Legal (38.5%), and Office and Administrative Support (37%).
- Computer and Mathematical (33.4%) comes in at 5th place, contrary to Anthropics results, which had the majority by a wide margin of these occuations represented in their usage data. However one possible reason for this could be that their tasks take longer to complete, which would result in less coverage and therefor automation.
- Educational Instruction and Library has a significant margin above the next closest major occupational category
- Lowest occupations ivolve more physicality as would be expected.
---

### % Major Occupational Category Automated Utah

**Description**
- Shows the percent of the tasks automated in the 23 major occupational categories as defined by the Bureau of Labor Statistics using Utah employment numbers.
- Each bar represents one majory occupational category
- Percentages indicate what share of that majory occupational category's total task completions are AI-automatable.
